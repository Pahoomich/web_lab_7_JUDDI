...
public class SimplePublish {
        ...
        public void publish(String businessesName, String serverName, String webWSDL) {
                try {

                        // Login aka retrieve its authentication token
                        GetAuthToken getAuthTokenMyPub = new GetAuthToken();
                        getAuthTokenMyPub.setUserID("uddiadmin");                    //your username
                        getAuthTokenMyPub.setCred("da_password1");                          //your password
                        ...
                        myBusName.setValue(businessesName);
                        ...
                        myServName.setValue(serverName);
